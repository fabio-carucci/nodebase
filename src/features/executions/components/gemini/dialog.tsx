...
type GeminiModelId = Parameters<typeof google>[0];
...
export const AVAILABLE_MODELS = [
  ...
  "gemma-3-12b-it",
  "gemma-3-27b-it",
] as const satisfies readonly GeminiModelId[];
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings for the Gemini Request node.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The Google Gemini Model to use for this request. You can
                    find more information about the available models in the{" "}
                    <a
                      href="https://developers.generativeai.google/models"
                      target="_blank"
